        ...
        if ligne.upper().startswith("MAIL FROM:"):
            ...
            if len(destinataires_valides) > 0:
                for d in destinataires_valides:
                    ...
                    with open(os.path.join(chemin_recp, nom_fichier), "w", encoding="utf-8") as f:
            ...
            if emetteur:
                ...
                with open(os.path.join(chemin_envoi, nom_fichier), "w", encoding="utf-8") as f:
                    f.write(contenu_historique)

            connexion.send(b"250 OK Message bien recu, et transmis au destinataire \r\n")
...
if __name__ == "__main__":
    ...
    # L'option SO_REUSEADDR permet de relancer le serveur immédiatement sans attendre pour plus de facilite au viveau des test
